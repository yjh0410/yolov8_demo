...
try:
    from .modules import ConvModule, C2PSA, YoloStage, SPPF, Upsample, Concat, Segment
except:
    from  modules import ConvModule, C2PSA, YoloStage, SPPF, Upsample, Concat, Segment
...
class Yolo11Seg(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        output, protos = self.model[23](pyramid_feats)
