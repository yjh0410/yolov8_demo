...
# build YOLO model
model_scale = "l"
yolo11 = Yolo11Seg(model_scale=model_scale, num_classes=80, num_masks=32).eval()

# load ckpt
ckpt = torch.load("checkpoints/yolo11{}_seg_ckpt.pth".format(model_scale), map_location="cpu")
